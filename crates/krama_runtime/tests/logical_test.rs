...
test_eval_ok!(eval_bang_operator_on_true, "!true", Object::Boolean(false));

test_eval_ok!(eval_bang_operator_on_false, "!false", Object::Boolean(true));

test_eval_ok!(eval_bang_operator_on_number, "!5", Object::Boolean(false));
